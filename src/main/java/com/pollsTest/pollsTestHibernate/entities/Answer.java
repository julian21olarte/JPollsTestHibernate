 ...
 */
@Entity
@Table(name = "answers", catalog = "polls_test", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Answer.findByUpdatedAt", query = "SELECT a FROM Answer a WHERE a.updatedAt = :updatedAt")})
public class Answer implements Serializable {
    ...
    */
    ...
    public Answer(Integer id, Date createdAt, Date updatedAt) {
        this.id = id;
   ...
   /* @XmlTransient
    ...
    public String toString() {
        return "com.pollsTest.pollsTestHibernate.entities.Answer[ id=" + id + " ]";
    }
